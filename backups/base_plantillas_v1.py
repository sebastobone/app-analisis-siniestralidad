...
def base_plantillas(
    ...
    return (
        ...
        .with_columns(
            cantidad_index_desarrollo=pl.concat_str(
                [pl.col("index_desarrollo"), pl.col("cantidad")], separator="_"
            )
        )
        .collect()
        .pivot(
            on="cantidad_index_desarrollo", index="periodo_ocurrencia", values="valor"
        )
    )
