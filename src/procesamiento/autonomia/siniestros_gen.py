...
async def main(mes_inicio: int, mes_corte: int, aproximar_reaseguro: bool) -> None:
    ...
    conteo_desistido = calcular_conteo(
    ...
    consolidado = (
        ...
        .with_columns(utils.crear_columna_apertura_reservas("autonomia"))
