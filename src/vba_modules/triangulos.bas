...
Sub consolidado_triangulos(ws, num_ocurrencias, num_alturas, header_triangulos, sep_triangulos, fila_ini_plantillas, col_ocurrs_plantillas, atributo)
    ...
    If ws.Name = "Plantilla_Plata" Then
        ...
        Call columna_consolidado(ws, num_ocurrencias, fila_tabla, 8, "Prima Devengada", "=SUMIFS(IF(Atributos!R2C1 = ""Bruto"", Aux_Totales!C" & col_auxtot("prima_bruta_devengada") & ", Aux_Totales!C" & col_auxtot("prima_retenida_devengada") & "), Aux_Totales!C" & col_auxtot("periodo_ocurrencia") & ", RC1, Aux_Totales!C1, Aperturas!R2C1)", formato)
...
Sub generar_Plantilla_Frec(num_ocurrencias, num_alturas, header_triangulos, sep_triangulos, fila_ini_plantillas, col_ocurrs_plantillas, atributo, mes_del_periodo)
    ...
    Call consolidado_triangulos(ws, num_ocurrencias, num_alturas, header_triangulos, sep_triangulos, fila_ini_plantillas, col_ocurrs_plantillas, atributo)
...
Sub generar_Plantilla_Seve(num_ocurrencias, num_alturas, header_triangulos, sep_triangulos, fila_ini_plantillas, col_ocurrs_plantillas, atributo, mes_del_periodo)
...
Sub generar_Plantilla_Plata(num_ocurrencias, num_alturas, header_triangulos, sep_triangulos, fila_ini_plantillas, col_ocurrs_plantillas, atributo, mes_del_periodo)
